...
const PreviousPanel = () => {
  return (
    <Box h={['auto', 'auto', '350px']} p={[2, 4]}>
      <Stack direction={['column', 'column', 'row']} w={'100%'} align='center' justify='center'>
...
const MyExperiences = () => {
  return (
    <Box borderRadius={"lg"} w={["90%", "100%", "100%"]} p={[4, 6, 8]} mx={'auto'} mt={[8, ,-10]}>
      <Heading as="h1" align={'center'} justify='center' size={['lg', 'xl', '2xl']} mb={4} className="pulse-gradient">My Experience</Heading>
